        ...
        try:
            ...
            for item in sql_list:
                ...
                if 'sql' in item:
                    ...
                    normalized_sql = sql_statement.strip().rstrip(';').lower()
                    if normalized_sql in ("select 1", "select 1 from dual"):
                        results.append({
                            "sql_id": item['sql_id'],
                            "sql": sql_statement,
                            "status": "placeholder",
...
if __name__ == '__main__':
    ...
    insert_file_path = "/mnt/d/下载/TGAC/final_for_student/data/insert_sql.json"
    insert_result_file_path = "/mnt/d/下载/TGAC/final_for_student/result/insert_exe_result.json"
    ...
    dataset_file_path = "/mnt/d/下载/TGAC/final_for_student/result/best_sql.json"
    # dataset_file_path = "/mnt/d/下载/TGAC/final_for_student/result/noselector.json"
    # dataset_file_path = "/mnt/d/下载/TGAC/final_for_student/output.json"
    # dataset_file_path = "/mnt/d/下载/TGAC/final_for_student/data/jiucuo.json"

    dataset_result_file_path = "/mnt/d/下载/TGAC/final_for_student/result/dataset_exe_result.json"
    # dataset_result_file_path = "/mnt/d/下载/TGAC/final_for_student/result.json"
